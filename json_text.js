...
arrPopups = [
    ...
    },
    {
        ...
        "text_uk": "<div class=\"i-header\">Джерела забруднювачів</div>" +
            ...
            "<br><br>" +
            "Джерела забруднення повітря розрізняють взалежності від забруднювача. " +
    ...
    },
    {
        ...
        "text_uk": "<div class=\"i-header\">Довідкова інформація</div>" +
            ...
            "З цієї причини ми не включили їх у малюнок. Проте, вони все також можуть вказувати на ще більші небезпеки для здоров’я від забруднення атмосферного повітря, як, наприклад: " +
...
arrUI = [
...

    {
        ...
        "text_uk": "<b>Як використовувати цей інтерактивний малюнок?</b>" +
            "<br><br>" +
            "На інтерактивному малюнку/рисунку зображено наслідки/вплив найвагоміших (з встановленим гранично допустимим вмістом)/типових забруднювачів атмосферного повітря на здоров’я" +
