...
arrPopups = [
    {
        ...
        "text_mn": "<div class=\"i-header\">Өнөөгийн байдал</div>" +
            ...
            "<br><br>" +
            "Өнгөрсөн 10 жилийн хугацаанд Улаанбаатар хотын хувьд нарийн ширхэглэгт тоосонцор, хүхрийн давхар исэл, азотын давхар исэл (РМ2.5, SO2, NO2) бохирдуулагчид хүйтний " +
            "улиралд байнга стандартыг давсан үзүүлэлттэй буюу өндөр бохирдолтой байсан бөгөөд 2019 оноос эхлэн түүхий нүүрсний хэрэглээг хорьсноос хойш агаар дахь РМ10, РМ2.5-н " +
            "хэмжээ 40% ба 36% тус тус буурсан боловч энэ нь стандартад нийцээгүй хэвээр байгаа. Харин хүхрийн давхар ислийн (SO2)агууламж 2020 оны хүйтний улирлаас эхлэн 41%-иар " +
            "огцом өссөн байна. Монгол орны бусад аймгуудын  хувьд жил бүр агаарын чанар улам дордож байгаа бөгөөд өргөн хэмжээний, нарийвчилсан судалгаанууд хэрэгцээтэй байна." +
            "<br><br>" +
            ...
            "зуны сүүлчээр бензпирен агууламж давамгайлсан байна. Эдгээр нь хүний эрүүл мэндэд өндөр эрсдэлтэй, шууд хорт хавдар тусах аюулт бодис юм.",
    ...
    },
    {
        ...
        "text_mn": "<div class=\"i-header\">Хязгаарлалт</div>" +
            ...
            "<br><br>" +
            "Дэлхийн эрүүл мэндийн байгууллагаас (ДЭМБ) баталсан <a href=\"https://apps.who.int/iris/handle/10665/345329\" target=\"_blank\">Агаарын Чанарын Удирдамж</a>" +
            "ид агаар бохирдуулагч бодисуудын агууламжийг (эрүүл мэндэд нөлөөгүй эсвэл бага нөлөөтэй) тодорхойлсон байдаг. Эдгээр утгыг шинжлэх ухааны нотолгоонд үндэслэн " +
            "тодорхойлсон бөгөөд бодлого боловсруулагчдад агаарын чанарын стандартыг тогтоохдоо баримтлах үндэслэл болгоход зориулагдсан болно. Агаарын бохирдлын урт хугацааны " +
            "үр нөлөөний хувьд  ихэнх бохирдуулагчдад нөлөөллийн босго агууламж байдаггүй хэмээн өнөөгийн шинжлэх ухааны  нотолгоонд тулгуурлан судлаачид таамаглаж байна. " +
            "\"Нөлөөллийн босго\" гэдэг нь эрүүл мэндэд хортой нөлөө үзүүлэхгүй байгаа бохирдуулагчийн агууламжийг хэлнэ. ДЭМБ одоогоор агаарын чанарын удирдамжаа шинэчилж байна." +
            "<br><br>" +
            "Монгол улсад агаарын чанарын стандартыг <a href=\"https://estandard.gov.mn/standard/v/3377\" target=\"_blank\">Засгийн газрын хэрэгжүүлэгч агентлаг Стандарт хэмжилзүйн газар</a>. " +
            "батлан гаргадаг. Энэхүү стандартыг ДЭМБ-ын Агаарын чанарын зөвлөмж (2006 он), АНУ-ын Байгаль хамгаалах агентлагын Агаар бохирдуулах бодисын агууламжийг удирдлага болгон боловсруулсан болно." +
            "<br><br>" +
            ...
            "давсан үзүүлэлттэй байгаа бөгөөд дулааны улиралд харьцангуй стандарт хэмжээнд байна. Харин " +
    ...
    },
    {
        ...
        "text_mn": "<div class=\"i-header\">Бохирдуулагч эх үүсвэрүүд</div>" +
            ...
            "<br><br>" +
            "Монгол орны агаарын бохирдолд хүйтний улиралд гэр хорооллын яндан, автомашин , цахилгааны дэд станцуудаас ялгарах утаа дийлэнх хувийг эзэлж байгаа бөгөөд " +
            "харин дулааны улиралд шороон шуурга, ойн түймэр болон машины утаа агаарыг бохирдуулж байна. Тодруулбал, " +
    ...
    },
    {
        ...
        "text_mn": "<div class=\"i-header\">Суурь өгөгдлүүд</div>" +
            ...
            "<br><br>" +
            "Насанд хүрсэн хүн өдөрт дундажаар 12'000-15'000 литр агаараар амьсгалдаг. Бидний уушги, амьсгалын зам руу амин чухал шаардлагатай хүчилтөрөгчөөс гадна эрүүл мэндэд " +
            "хортой болох нь батлагдсан агаар бохирдуулагч бодисууд хамар, хоолойгоор дамжин ордог." +
            "<br><br>" +
            "Энд танилцуулж буй мэдээлэл нь хүн амын түвшинд агаар дахь бохирдуулагчийн хүний эрүүл мэндэд үзүүлэх нөлөөг судалсан олон тооны тандалт судалгаан дээр үндэслэсэн болно. " +
            "Түүнчлэн хүн, амьтан, эсэд агаар бохирдуулагчид хэрхэн нөлөөлж буй туршилтын судалгааг өргөнөөр ашигласан." +
            "<br><br>" +
            "Агаарын бохирдолд өртөлтийн нөлөөг богино хугацааны (цаг, өдрөөр хэмжигдэх) болон урт хугацааны (сар, жилээр хэмжигдэх) хэмээн ангилдаг ба гадаад орчны " +
            "агаарын бохирдолд удаан хугацаагаар өртөх нь илүү ноцтой нөлөө үзүүлэх нь илэрхий байна." +
            "<br><br>" +
            "Энд танилцуулж буй зурагт мэдээлэл нь АНУ-ын Байгаль орчныг хамгаалах газраас хийсэн (EPA) үнэлгээнд үндэслэсэн ба EPA нь агаар бохирдуулагч болон " +
            "тэдгээрийн эрүүл мэндэд үзүүлэх нөлөөллийн хоорондын хамаарлыг таван түвшний хэмжүүрээр үнэлдэг. \"Шалтгаалж байгаа\" ба \"шалтгаантай байх магадлалтай\" " +
            "түвшин нь энэхүү учир шалтгааны хэмжүүрийн хамгийн дээд хоёр түвшин юм." +
            "<br><br>" +
            "Учир шалтгааны үнэлгээний талаарх дэлгэрэнгүй мэдээллийг доорх холбоосоор орж үзэх боломжтой:" +
            "<br><br>" +
            "<a href=\"https://cfpub.epa.gov/ncea/isa/recordisplay.cfm?deid=310244\" target=\"_blank\">«Preamble to the Integrated Science Assessments (ISA)»</a>." +
            "<br><br>" +
            "АНУ-ын Байгаль орчныг хамгаалах газрын үнэлгээ шиг нарийвчилсан биш ч гэсэн сүүлийн үеийн өөр нотлох баримтууд бий. Хэдийгээр бид эдгээр баримтуудыг зурагт " +
            "оруулаагүй ч эрүүл мэндэд илүү их хор хөнөөлтэй байж магадлалтай. Тухайлбал, жин багатай ураг, мэдрэлийн хөгжилд үзүүлэх нөлөө, чихрийн шижин, хорт хавдар гэх мэт." +
            "<ul>" +
            "<li><a href=\"https://www.healtheffects.org/publication/systematic-review-and-meta-analysis-selected-health-effects-long-term-exposure-traffic\" target=\"_blank\">" +
            "Авто замын түгжрэлээс үүдэлтэй эрүүл мэндийн нөлөөллийг Эрүүл Мэндийн Нөлөөллийн Хүрээлэн</a>гээс хийсэн бөгөөд энэхүү тоймд тус бохирдуулагчаас үүдэлтэй 2-р хэлбэрийн " +
            "чихрийн шижин, зүрхний ишемийн өвчин, жин багатай ураг зэрэг эрсдлүүд нөлөөтэй байгааг нотолсон байна.</li>" +
            "<li><a href=\"https://www.eionet.europa.eu/etcs/etc-he/products/etc-he-products/etc-he-reports/" +
            "etc-he-report-2022-22-environmental-health-risks-to-children-and-adolescents-an-umbrella-review-on-indoor-and-outdoor-air-pollution\" target=\"_blank\">" +
            "Хүний эрүүл мэнд, хүрээлэн буй орчны Европын сэдэвчилсэн төвийн хийсэн</a> бага насны хүүхэд болон өсвөр насныханд гадаад болон дотоод орчны агаарын бохирдлоос үүдэлтэй " +
            "эрүүл мэндийн нөлөөллийг судалсан тойм эмхэтгэлд хүүхдийн нас баралт, жин багатай ураг, дутуу төрөлт, мэдрэлийн хөгжлийн саатал, аутизм, лейкеми болон халдвар зэрэг " +
            "нэмэлт нотлох баримтуудыг тусгасан.</li>" +
            "<li>2021 оны Дэлхийн өвчлөлийн дарамтын судалгаа (Global Disease Burden Study) эрүүл мэндийн нөлөөллийг (1) зүрхний ишемийн өвчин, цус харвалт, " +
            "уушгины архаг бөглөрөлт өвчин (COPD), уушгины хорт хавдар, амьсгалын замын цочмог халдвар, II хэлбэрийн чихрийн шижин, дутуу төрөлт, бага жинтэй ураг; " +
            "(2) уушгины архаг бөглөрөлт өвчин (COPD) үүсгэгч озоноос үүдэлтэй нас баралт; (3) хүүхэд, өсвөр үеийнхний астма өвчнийг үүсгэгч азотын давхар исэл зэрэгтэй " +
            ...
            "<br><br>" +
            "Аливаа аюул нь хохирол учруулдаг гэдгийг бид мэднэ. Нөгөө талаас эрсдэл гэдэг нь ямар нэг аюул бодитоор хохирол учруулах магадлал юм. Энэ нь бодит өртөлттэй хавсарсан аюулын үр дүн юм." +
            "<br><br>" +
            ...
            "Агаар бохирдуулагчийн хүнд үзүүлэх нөлөө нь тамхи татах гэх мэт амьдралын эрсдэлт хүчин зүйлстэй харьцуулахад бага юм." +
            "<br><br>" +
            "Гэсэн хэдий ч хүн амын түвшинд, ялангуяа нийгмийн эрүүл мэндийн үүднээс авч үзвэл хүн ам бүхэлдээ агаар бохирдуулагчийн нөлөөнд автдаг учраас, тамхидалтаас ялгаатай нь дээр дурдсан 6% ийн эрсдэл хэдий бага харагдаж буй ч анхаарал татахуйц тоо юм." +
            "<br><br>" +
    ...
    },
    {
        ...
        "text_mn": "<div class=\"i-header\">Таны оролцоо</div>" +
            ...
            "<br><br>" +
            "Агаарын чанарыг сайжруулах нь зөвхөн шийдвэр гаргагч нарын хүлээх үүрэг биш бөгөөд бид бүгд дор бүрнээ арга хэмжээ авах хэрэгтэй. Хэрэв та агаарын бохирдлыг бууруулахын тулд " +
    ...
    },
    {
        ...
        "text_mn": "<div class=\"i-header\">Ном зүй</div>" +
            "Энэхүү тайлбарт зурагт харуулсан өгөгдөл нь АНУ-ын Байгаль орчныг хамгаалах агентлагийн одоогийн шинжлэх ухааны нэгдсэн үнэлгээнд үндэслэсэн болно. " +
            "<a href=\"https://www.epa.gov/isa\" target=\"_blank\">(www.epa.gov/isa)</a>." +
            "<br><br>" +
            "<ol>" +
            "<li>U.S. EPA. Integrated Science Assessment (ISA) for Particulate (Final Report). U.S. Environmental Protection Agency, Washington, DC, EPA/600/R-19/188, 2019.</li>" +
    ...
    },
    {
        ...
        "text_uk": "<div class=\"i-header\">Вихідні дані</div>" +
         ...
         "text_mn": "<div class=\"i-header\">Эх сурвалж</div>" +
            "Энэхүү тайлбарт зургаар хүрээлэн буй орчны агаарын бохирдлын эрүүл мэндэд үзүүлэх нөлөөллийг харуулсан ба Swiss Tropical ба Нийгмийн эрүүл мэндийн хүрээлэнгийн (Швейцарийн TPH) " +
            ...
            "Энэхүү тайлбарт зураг нь " +
            "<a href=\"https://www.gnu.org/licenses/agpl-3.0\" target=\"_blank\">GNU Affero General Public License (AGPL)</a>. " +
            "лицензтэй. Тайлбарт зургийг ашиглах, тохируулахыг зохиогчийн хувьд Швейцарийн TPH-ээс лавлаж, AGPL лицензийн нөхцлийн дагуу зөвшөөрнө. Санал хүсэлтийг " +
            "<a href=\"&#x6d;&#x61;&#x69;&#x6c;&#x74;&#x6f;&#x3a;&#x6c;&#x75;&#x64;&#x6f;&#x6b;&#x40;&#x73;&#x77;&#x69;&#x73;&#x73;&#x74;&#x70;&#x68;&#x2e;&#x63;&#x68;\">" +
...
arrInfos = [
    {
        ...
        "text_mn": "<div class=\"i-header\">Амьсгалын систем</div>Уушги, амьсгалын хоолой (цагаан хоолой), амьсгалын зам (гуурсан хоолой ба гуурсанцар), агаарын уут (цулцан)",
    ...
    },
    {
        ...
        "text_mn": "<div class=\"i-header\">Зүрх судасны систем</div>Зүрх, цус болон судас",
    ...
    },
    {
        ...
        "text_mn": "<div class=\"i-header\">Мэдрэлийн систем</div>Тархи, мэдрэлийн систем",
    ...
    },
    {
        ...
        "text_mn": "<div class=\"i-header\">Бодисын солилцоо/дархлааны систем</div>Элэг, нойр булчирхай, дархлааны хамгаалалт",
    ...
    },
    {
        ...
        "text_mn": "<div class=\"i-header\">Нас баралт</div>Хүн амтай харьцууласан нас баралтын тоо",
    ...
    },
    {
        ...
        "text_mn": "<div class=\"i-header\">Амь тэнсэх тохиолдол</div>Амь тэнсэх үед түргэн тусламж дуудан эмнэлэгт хүргэгдэх болон эмчид хандах тохиолдол",
    ...
    },
    {
        ...
        "text_uk": "<div class=\"i-header\">Причинно-наслідковий</div>" +
            ...
            "<br><br>" +
            "Наприклад, важко встановити вплив забруднювачів, які діють одночасно, або доказові дані у різних наукових дисциплінах можуть бути обмеженими чи суперечливими.",
        "text_mn": "<div class=\"i-header\">Учир шалтгааны үнэлгээ</div>" +
            "<b>Шалтгаант</b>" +
            "<br><br>" +
            "Агаарт агуулагдах хорт бодисууд нь эс, амьтан, хүн, эпидемиологийн бүх судалгаагаар хүний эрүүл мэнд " +
            "болон амьдралын чанарын бүх түвшинд сөрөг нөлөө үзүүлдэг болох нь нотлогдсон." +
    ...
    },
    {
        ...
        "text_mn": "<div class=\"i-header\">Озон (O<sub>3</sub>)</div>Азотын давхар исэл, дэгдэмхий органик нэгдлүүд (VOC) зэрэг урьдал бодисуудаас үүссэн нарны цацрагтай урвалд орж үүссэн",
    ...
    },
    {
        ...
        "text_mn": "<div class=\"i-header\">Азотын давхар исэл (NO<sub>2</sub>)</div>Голдуу замын хөдөлгөөн болон чулуужсан түлшний шаталтын үйл явцаас ялгардаг",
...
arrUI = [
...

    {
        ...
        "text_mn": "<b>Хэрхэн энэхүү тайлбарт зургийг ашиглах вэ?</b>" +
            "<br><br>" +
            "Бид хүрээлэн буй орчны агаар дахь бохирдуулагч бодисын эрүүл мэндэд үзүүлэх нөлөө, байж болзошгүй учир шалтгааны холбоог энэхүү тайлбарт зургаар нэгтгэн гаргалаа." +
            "<ul>" +
