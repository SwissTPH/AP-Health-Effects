...
arrPopups = [
    {
        ...
        "text_uk": "<div class=\"i-header\">Поточний рівень забрудненості</div>" +
            ...
            "і зваженими (твердими) частинками (PM10/PM2,5). Це пояснюється тим, що великі кількості цих забруднювачів повітря продовжують викидатися та випускатися у повітря Швейцарії та сусідніх країн." +
            "<br><br>" +
